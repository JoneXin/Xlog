(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('chalk'), require('fs'), require('constants'), require('stream'), require('util'), require('assert'), require('path'), require('events'), require('os'), require('http'), require('https'), require('url'), require('tty'), require('zlib')) :
    typeof define === 'function' && define.amd ? define(['exports', 'chalk', 'fs', 'constants', 'stream', 'util', 'assert', 'path', 'events', 'os', 'http', 'https', 'url', 'tty', 'zlib'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.logger = {}, global.chalk, global.require$$1, global.require$$0$1, global.require$$0$2, global.require$$4, global.require$$5, global.require$$1$1, global.require$$1$2, global.os$1, global.require$$1$4, global.require$$2, global.require$$0$3, global.require$$1$3, global.require$$8));
})(this, (function (exports, chalk, require$$1, require$$0$1, require$$0$2, require$$4, require$$5, require$$1$1, require$$1$2, os$1, require$$1$4, require$$2, require$$0$3, require$$1$3, require$$8) { 'use strict';
